...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(),message, userAvatarView);
        }else{
            EaseUserUtils.setUserAvatar(context, message.getFrom(),message, userAvatarView);
            EaseUserUtils.setUserNick(message.getFrom(),message, usernickView);
        }
