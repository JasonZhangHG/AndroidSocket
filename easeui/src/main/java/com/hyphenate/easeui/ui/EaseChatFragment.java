...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
  ...
  /*  String userId = "";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       /* userUrl = fragmentArgs.getString("url");
        userId = fragmentArgs.getString("username");
        userName = fragmentArgs.getString("name");*/
    ...
    protected void setUpView() {
        ...
        String nickName = fragmentArgs.getString(EaseUI.nameTokens);
    ...
    protected void onConversationInit() {
        Log.e("!!!!!!!!!", "to:" + toChatUsername + "-t:" + chatType);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        Log.e("222222", "接受到消息：" + messages.get(0).toString());
    ...
    private void sendAtMessage(String content) {
        ...
        EMMessage message = EMMessage.createTxtSendMessage(content, toChatUsername);
       /* message.setAttribute("userName", "你是sb");
        message.setAttribute("userID", "ni caishi ");
        message.setAttribute("userUrl", "好吧，你是");*/
        EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
    ...
    protected void sendMessage(EMMessage message) {
        ...
        try {
            Log.e("bbbb", message.getStringAttribute(EaseUI.nameTokens).toString());
            Log.e("bbbb", message.getStringAttribute(EaseUI.headTokens).toString());
